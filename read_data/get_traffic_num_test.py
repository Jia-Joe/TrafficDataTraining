...
sys.path.append("f:/di____di/season_1/test_set_1/")

import get_traffic_num_test as gtn

import os
os.chdir('f:/di____di/season_1/gbdt/')
import gbdt_did_recv as tr
os.chdir('f:/di____di/season_1/test_set_1/')
'''
...
def get_traffic_num(fn):		
	df=pd.read_table('traffic_data/traffic_data_2016-01-'+filen2s(fn)+'_test',header=None,names=['district_hash','tj_level1','tj_level2','tj_level3','tj_level4','tj_time'])	
	...
	sdf.to_csv('traffic_weather_data/traffic_num_data_2016-01-'+filen2s(fn)+'_test.csv',columns=['district_id','tj_time_slice','tj_level1','tj_level2','tj_level3','tj_level4'],index=False);
